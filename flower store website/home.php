...
<section class="home">
   ...
   <div class="content">
      <h3></h3>
      <p>Chúng tôi cung cấp cho bạn những mẫu đồng hồ chuẩn gu thời trang nhất.</p>
      <a href="about.php" class="btn">Khám phá nhiều hơn</a>
   </div>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <?php
         $select_products = mysqli_query($conn, "SELECT * FROM `clock_admin` LIMIT 6") or die('query failed');
         if(mysqli_num_rows($select_products) > 0){
            while($fetch_products = mysqli_fetch_assoc($select_products)){
      ?>
      <form action="" method="POST" class="box">
         <a href="view_page.php?pid=<?php echo $fetch_products['id']; ?>" class="fas fa-eye"></a>
         <div class="price"><?php echo $fetch_products['price_sale']; ?>Đ</div>
         <img src="../quantri_dongho./<?php echo $fetch_products['image']; ?>" alt="" class="image">
         <div class="name"><?php echo $fetch_products['name']; ?></div>
         <input type="number"  id = "quantity"name="product_quantity" value="1" min="1"  max = "<?=$fetch_products['quantity_stock']?>"  class="qty">
   ...
   <div class="more-btn">
      <a href="shop.php" class="option-btn">Xem nhiều hơn</a>
   </div>
...
<section class="home-contact">
   ...
   <div class="content">
      ...
      <a href="contact.php" class="btn">Liên lạc tôi</a>
   </div>
