  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      ...
      <span class="navbar-text">
        ...
        $hotels = mysqli_query($connect, "SELECT * FROM `hotel` ORDER BY `id` ASC  LIMIT " . $item_per_page . " OFFSET " . $offset);
        $totalRecords = mysqli_query($connect, "SELECT * FROM `hotel`");
        $totalRecords = $totalRecords->num_rows;
        $totalPages = ceil($totalRecords / $item_per_page);
        ?>
        <div class="container">
            <h1>Danh sách các khách sạn đã thêm</h1>
