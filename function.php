...
function checkPrivilege() {
    ...
    $privileges = array(
        ...
        "clock_edit\.php\?action=edit&id=\d+$",
        "member_editing\.php\?action=edit&id=\d+$",
        "clock_edit\.php\?action=add",
        "member_editing\.php\?action=add",
        "clock_list\.php\?action=search",
        "clock_delete\.php\?id=\d+$",   
        "gallery_delete\.php\?id=\d+$",   
